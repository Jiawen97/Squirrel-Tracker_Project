...
class sightings(models.Model):
    Latitude=models.DecimalField(max_digits=100,decimal_places=13,help_text=_(
'Longitude'),)

    Longitude=models.DecimalField(max_digits=100,decimal_places=13,help_text=_(
'Latitude'),)

    Unique_Squirrel_ID=models.CharField(max_length=100, help_text=_('ID'),)
    ...
    Age=models.CharField(max_length=100,choices=Age_choices,default=Other,
            help_text=_('Age'),)
    ...
    Primary_Fur_Color=models.CharField(max_length=100,
            choices=Primary_Fur_Color_choices,default=Other)
    ...
    Location=models.CharField(max_length=100,
            choices=Location_choices,default=Other)
